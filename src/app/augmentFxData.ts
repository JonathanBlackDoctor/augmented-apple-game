...
export const ACT: Record<string, ActSpec> = {
  ...
  "risk.glasscannon": {"kind":"speed","glow":"prism","shatter":true,"badges":[{"t":"×2","c":"prism","big":true},{"t":"타이머 2×","c":"red"}]},
  "risk.tightrope": {"kind":"gauge","glow":"gold","drain":true,"badges":[{"t":"1.6×","c":"gold","big":true},{"t":"−8초","c":"red"}]},
  "risk.gambler": {"kind":"dice","glow":"prism","results":[{"t":"2×","c":"green"},{"t":"0.5×","c":"red"}]},
};
