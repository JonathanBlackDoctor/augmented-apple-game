...
export const ACT: Record<string, ActSpec> = {
  ...
  "time.lord": {"kind":"window","glow":"prism","badges":[{"t":"상대 ? 1초","c":"prism","big":true}]},
  ...
  "combo.massacre": {"kind":"burst","glow":"gold","badges":[{"t":"3×","c":"gold","big":true}]},
  "board.rearrange": {"kind":"spawn","glow":"silver","spawn":{"type":"triplet","count":2},"badges":[{"t":"합10 ×2","c":"silver"}]},
  ...
  "board.rainbow": {"kind":"spawn","glow":"prism","spawn":{"type":"wild","count":8},"badges":[{"t":"빈칸 채움","c":"prism"}]},
  "board.companion": {"kind":"burst","glow":"green","badges":[{"t":"새콤이 합류!","c":"green","big":true}]},
